...
<body class="w3-black">
    ...
    <div class="w3-container w3-col w3-row w3-center ">
        <div class="w3-col w3-button w3-blue w3-cell w3-round-large w3-margin-right w3-margin-left" style="width:22.96%;">
        ...
        <div class="w3-col w3-button w3-red w3-cell w3-round-large w3-margin-right w3-margin-left" style="width:22.96%;">
        ...
        <div class="w3-col w3-button w3-deep-purple w3-cell w3-round-large w3-margin-right w3-margin-left" style="width:22.96%;">
            <a href="listar.php" style="text-decoration: none;">
        ...
        <div class="w3-col w3-button w3-indigo w3-cell w3-round-large w3-margin-right w3-margin-left" style="width:22.96%;">
            <a href="listar.php" style="text-decoration: none;">
